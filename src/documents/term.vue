...
<template>
  <div class="">
    <a-typography-title :level="2" style="margin-bottom: 24px;">MySekaiShare 用户协议</a-typography-title>
    
    <a-typography-title :level="3">一、用户协议总则</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
      1、本协议双方为 <a-typography-text strong> DRComicUnited江愿漫联 （以下简称"运营方"）</a-typography-text>和<a-typography-text strong> MySekaiShare（包括网站等产品提供的服务，以下简称"产品和服务"）</a-typography-text>的<a-typography-text strong>注册用户（以下简称"用户"）</a-typography-text>。
    ...
    <a-typography-title :level="3">二、用户服务使用说明</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
      1、用户在注册时应按照注册提示填写准确的 用户名、密码、电子邮箱地址 等相关个人资料，符合完整、准确、真实的要求。
    </a-typography-paragraph>
    <a-typography-paragraph style="text-indent: 2em;">
    ...
    <a-typography-paragraph style="text-indent: 2em;">
      8、用户不得将本站任何内容用于商业用途(包括但不限于:售卖本站地址、本站数据、或将本站含地址在内的任何信息作为任何有偿的售卖赠品)
    </a-typography-paragraph>

    <a-typography-title :level="3">三、协议内容的变更和修订</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
    ...
    <a-typography-paragraph style="margin-left: 4em;">
      （1）自行停止使用运营方的网络服务。
    </a-typography-paragraph>
    <a-typography-paragraph style="margin-left: 4em;">
    ...
    <a-typography-title :level="3">四、用户隐私保护</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
    ...
    <a-typography-title :level="3">五、注册用户的权利与义务</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
    ...
    <a-typography-title :level="3">六、运营方网络服务内容的所有权</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
      1、运营方定义的网络服务内容包括但不限于：非交互式社交、游戏周边、工具等。该等内容均受《著作权法》、《商标法》、《专利法》、《计算机软件保护条例》及其他相关法律法规的保护。
    </a-typography-paragraph>

    <a-typography-title :level="3">七、免责声明</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
    ...
    <a-typography-title :level="3">八、其他约定</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
    ...
    <a-typography-title :level="3">九、联系我们</a-typography-title>
    <a-typography-paragraph style="text-indent: 2em;">
      如果您对本协议或本服务有任何疑问、意见或建议，可通过以下方式与我们联系：
    </a-typography-paragraph>
    <a-typography-paragraph style="text-indent: 2em;">
      （1）拨打客服热线电话+85263408647
    </a-typography-paragraph>
    <a-typography-paragraph style="text-indent: 2em;">
      （2）发送电子邮件至：customer@dreameriver.cn
    </a-typography-paragraph>
    <a-typography-paragraph style="text-indent: 2em;">
      （3）联系地址：中华人民共和国香港特别行政区九龙尖沙咀东科学馆道14号新文华中心OfficeBuildingB3102-3106，联系人：Wong YukCheung<br>
    </a-typography-paragraph>
    <a-typography-paragraph style="text-indent: 2em;">
    中国内地区域非营利业务由青岛江愿文化发展有限公司代办。本文列出的所有企业与非营利组织均不持有Project SEKAI游戏及其衍生内容的版权。并承诺不会将其游戏和衍生内容用于任何形式的商业用途。
    </a-typography-paragraph>
    <a-typography-paragraph style="text-indent: 2em;">
      （完）
    </a-typography-paragraph>
